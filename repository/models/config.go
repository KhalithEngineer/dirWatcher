...
type Config struct {
	...
	Directory    null.String `boil:"directory" json:"directory,omitempty" toml:"directory" yaml:"directory,omitempty"`
	MagicString  null.String `boil:"magic_string" json:"magic_string,omitempty" toml:"magic_string" yaml:"magic_string,omitempty"`
	TimeInterval null.Int    `boil:"time_interval" json:"time_interval,omitempty" toml:"time_interval" yaml:"time_interval,omitempty"`
...
var ConfigTableColumns = struct {
	...
	MagicString:  "config.magic_string",
...
var ConfigWhere = struct {
	ID           whereHelperint
	Directory    whereHelpernull_String
	MagicString  whereHelpernull_String
	TimeInterval whereHelpernull_Int
}{
	ID:           whereHelperint{field: "\"config\".\"id\""},
	Directory:    whereHelpernull_String{field: "\"config\".\"directory\""},
	MagicString:  whereHelpernull_String{field: "\"config\".\"magic_string\""},
	TimeInterval: whereHelpernull_Int{field: "\"config\".\"time_interval\""},
}
...
var (
	configAllColumns            = []string{"id", "directory", "magic_string", "time_interval"}
	configColumnsWithoutDefault = []string{}
	configColumnsWithDefault    = []string{"id", "directory", "magic_string", "time_interval"}
...
func (q configQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Config, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: failed to execute a one query for config")
	}
...
func (q configQuery) All(ctx context.Context, exec boil.ContextExecutor) (ConfigSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbmodels: failed to assign all query results to Config slice")
	}
...
func (q configQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to count config rows")
	}
...
func (q configQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: failed to check if config exists")
	}
...
func FindConfigG(ctx context.Context, iD int, selectCols ...string) (*Config, error) {
...
func FindConfig(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Config, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: unable to select from config")
	}
...
func (o *Config) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbmodels: no config provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to insert into config")
	}
...
func (o *Config) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbmodels: unable to update config, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update config row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by update for config")
	}
...
func (q configQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update all for config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to retrieve rows affected for config")
	}
...
func (o ConfigSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update all in config slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to retrieve rows affected all in update all config")
	}
	return rowsAff, nil
}
...
func (o *Config) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("dbmodels: no config provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbmodels: unable to upsert config, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(configPrimaryKeyColumns) == 0 {
				return errors.New("dbmodels: unable to upsert config, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to upsert config")
	}
...
func (o *Config) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbmodels: no Config provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by delete for config")
	}
...
func (q configQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbmodels: no configQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete all from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by deleteall for config")
	}
...
func (o ConfigSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete all from config slice")
	}
...
func (o *Config) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: no Config provided for reload")
	}
...
func (o *ConfigSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: empty ConfigSlice provided for reload all")
	}
...
func (o *ConfigSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to reload all in ConfigSlice")
	}
...
func ConfigExistsG(ctx context.Context, iD int) (bool, error) {
...
func ConfigExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: unable to check if config exists")
	}
